...
Route::group(['prefix' => 'backend', 'middleware' => 'auth', 'as'=>'backend'], function() {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    Route::group(['prefix' => 'supir','middleware' => ['role:admin|operator'], 'as'=>'.supir'], function() {
        Route::get('/', 'Backend\SupirController@index')->name('.manage');
        Route::get('/create', 'Backend\SupirController@create')->name('.create');
        Route::post('/create', 'Backend\SupirController@store')->name('.store');
        Route::get('/update/{id}', 'Backend\SupirController@edit')->name('.edit');
        Route::post('/update/{id}', 'Backend\SupirController@update')->name('.update');
        Route::get('/detail/{id}', 'Backend\SupirController@show')->name('.detail');
    });
    ...
    |--------------------------------------------------------------------------
    */
    Route::group(['prefix' => 'kernet','middleware' => ['role:admin|operator'], 'as'=>'.kernet'], function() {
        Route::get('/', 'Backend\KernetController@index')->name('.manage');
        Route::get('/create', 'Backend\KernetController@create')->name('.create');
        Route::post('/create', 'Backend\KernetController@store')->name('.store');
        Route::get('/update/{id}', 'Backend\KernetController@edit')->name('.edit');
        Route::post('/update/{id}', 'Backend\KernetController@update')->name('.update');
        Route::get('/detail/{id}', 'Backend\KernetController@show')->name('.detail');
    });
    ...
    */
    Route::group(['prefix' => 'transaksi','middleware' => ['role:admin|operator'], 'as'=>'.transaksi'], function() {
        ...
        Route::group(['prefix' => 'detail','middleware' => ['role:admin|operator'], 'as'=>'.detail'], function() {
            Route::get('/create/{id}', 'Backend\TransaksiController@detail_create')->name('.create');
            Route::post('/create/{id}', 'Backend\TransaksiController@detail_store')->name('.store');
        });
    });
