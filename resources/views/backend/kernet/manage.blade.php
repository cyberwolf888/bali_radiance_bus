...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{ route('backend.kernet.manage') }}">Kernet</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Kelola Kernet</span>
                    </div>
                    <div class="actions">
                        @role('admin')
                        <div class="btn-group btn-group-devided">
                            <a href="{{ route('backend.kernet.create') }}" class="btn btn-circle green">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    ...
                                    <td class="center" @role('operator') width="150" @endrole @role('admin') width="120" @endrole >
                                        <a href="{{ route('backend.kernet.edit',$row->id) }}" class="btn yellow-saffron btn-xs"><i class="fa fa-pencil"></i></a>
                                        <!-- <a href="{{ route('backend.kernet.detail',$row->id) }}" class="btn green-steel btn-xs"><i class="fa fa-eye"></i></a> -->
                                    </td>
                                </tr>
                                <?php $no++ ?>
                            @endforeach
