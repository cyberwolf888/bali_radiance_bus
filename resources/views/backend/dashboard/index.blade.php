            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        ...
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \App\Models\Transaksi::whereRaw("MONTH(created_at) = ".date('m'))->count() }}">0</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        ...
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \DB::table('transaksi')->select(\DB::Raw('SUM(total) as profit'))->whereRaw("MONTH(created_at) = ".date('m'))->get()[0]->profit }}">0</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
            ...
            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                ...
                <div class="widget-thumb-wrap">
                    ...
                    <div class="widget-thumb-body">
                        ...
                        <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ \App\Models\Kendaraan::count() }}">0</span>
                    </div>
                </div>
            </div>
            <!-- END WIDGET THUMB -->
